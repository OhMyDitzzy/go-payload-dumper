...
type Signatures_Signature struct {
	...
	UnpaddedSignatureSize *uint32 `protobuf:"varint,3,opt,name=unpadded_signature_size,json=unpaddedSignatureSize" json:"unpadded_signature_size,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_protos_update_metadata_proto_rawDesc = "" +
	...
	"\x17unpadded_signature_size\x18\x03 \x01(\rR\x15unpaddedSignatureSize\"7\n" +
	...
	"\fApexMetadata\x12=\n" +
	"\tapex_info\x18\x01 \x03(\v2 .chromeos_update_engine.ApexInfoR\bapexInfo\"\xaf\x04\n" +
	...
	"\x14security_patch_level\x18\x12 \x01(\tR\x12securityPatchLevelB\tZ\aprotos/"
